...
PROJECT_NAME ?= provider-mongodb-atlas
...
export TERRAFORM_PROVIDER_VERSION ?= 1.34.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= # mongodbatlas
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-mongodbatlas_v1.34.0
...
xpkg.build.provider-mongodb-atlas: do.build.images
